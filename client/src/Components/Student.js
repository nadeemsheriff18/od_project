...
const Student = () => {
  ...
  return (
    <div className="w-full min-h-screen bg-violet-100 pt-24">
      ...
      <div className="flex flex-col lg:flex-row justify-evenly items-center pt-7 px-6 lg:px-20">
        ...
        {/* OD Info Section */}
        <div className="w-full lg:w-1/3 flex items-center lg:px-24 text-lg font-bold text-purple-800">
