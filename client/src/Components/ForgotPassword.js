...
function ForgotPassword() {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`http://localhost:3001/changepwd`, {
            method: 'POST',
          ...
          >
            Your password
                        ...
                        <input
                            ...
                            required
                        />
                        <input type='submit' className='placeholder:text-center text-lg border-2 rounded-xl p-1 bg-purple-300 cursor-pointer hover:bg-purple-700' onClick={(e) => handleSubmit(e)} />
                        {error && <p>{error}</p>}
                    </div>
